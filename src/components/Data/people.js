...
const peopleData = [
  ...
  },
  {
    ...
    image: Person3,
    description:
      `Ms. Isha Baloni is an Advocate enrolled with the Bar Council of Delhi. She holdsa B.B.A. L.L.B. degree from Maharishi University of Information Technology, Noida, and has developed a comprehensive practice encompassing Civil and Criminal Litigation, Mining Laws, Consumer and Excise Matters, Revenue Laws, Arbitration, and Corporate Advisory. Ms. Baloni regularly appears before the Hon’ble Supreme Court of India, Delhi High Court, various District Courts, the National Green Tribunal, and the National Consumer Disputes Redressal Commission, and has contributed to several reported judgments.
      
      She possesses strong expertise in drafting Writ Petitions, Counter Affidavits, Special Leave Petitions, Revision Petitions, Consumer Complaints, Civil and Commercial Suits, Bail Applications, Review Petitions, Legal Notices, Representations, and Legal Opinions for both private entities and Government departments. Ms. Baloni has assisted in briefing Senior Counsels in complex and high-stakes matters and has previously worked with reputed law offices, including the Chambers of Sadineni Ravi Kumar (AOR) and the Chambers of Prashant Manchanda. An accomplished researcher and persuasive legal writer, she has published papers on Alternative Dispute Resolution, Maritime Law, and Cyber Laws, and has distinguished herself as a quarter-finalist in national and international moot court competitions. Her practice is marked by precision, diligence, and a growing specialization in mining, environmental, and regulatory law.`,
  },
  {
    id: "sreeraj-prabhakaran-k",
    name: "Sreeraj Prabhakaran K",
    image: Person4,
    description:
      `Sreeraj Prabhakaran is a highly capable legal professional specialising in Intellectual Property Rights, with focused expertise in copyright law, patent law, and IP enforcement mechanisms. With a strong academic background and a deep understanding of the evolving landscape of intellectual property, he has developed a reputation for delivering precise, strategic, and commercially sound legal solutions. His practice includes advising and representing clients across diverse sectors such as technology, media, pharmaceuticals, manufacturing, and creative industries. Over the years, he has handled matters relating to copyright infringement, patent registration and protection, licensing disputes, IP portfolio management, and due-diligence for innovative businesses. His nuanced understanding of statutory frameworks, combined with practical insight, allows him to safeguard intangible assets with clarity and foresight.
