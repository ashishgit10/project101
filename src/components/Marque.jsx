...
const Marque = () => {
    return (<>
        ...
        <section className="bg-[#0b2540] text-white w-full">
            {/* ===================== Top Section ===================== */}

            <div className="py-12 md:py-16  w-full">
                {/* 🔹 Top Row: Auto-scrolling logos */}
              

                {/* 🔹 Impact Section */}
                <div className="w-full px-4 sm:px-6 lg:px-12 flex flex-col lg:flex-row gap-10 lg:gap-12">
                    {/* LEFT - Quote Box */}
                    <div className="relative border border-[#B6654C] p-6 sm:p-8 lg:p-10 flex-1 text-center">
                        ...
                        {/* Quote text */}
                        <p className="text-[#9FD6B2] italic text-base sm:text-lg md:text-xl leading-relaxed mb-6">
                    ...
                    <div className="flex-1">
                        <h3 className="text-[#9FD6B2] text-2xl sm:text-3xl font-semibold mb-6 text-center lg:text-left">
                            Impact
                        </h3>
            ...
            <div className="w-full px-4 sm:px-6 lg:px-12 py-12 md:py-16 flex flex-col lg:flex-row gap-10 lg:gap-12">
                ...
                <div className="flex-1 relative">
                    <h3 className="text-[#9FD6B2] text-2xl sm:text-3xl font-semibold mb-6">
                        Careers
                    </h3>
                    <ul className="space-y-4 sm:space-y-6 text-[#B6654C] font-semibold">
                        {[
                    ...
                    <img
                        src={LeafPattern}
                        alt="leaf"
                        className="absolute bottom-0 left-0 w-28 sm:w-32 md:w-40 opacity-80"
                    />
                </div>
